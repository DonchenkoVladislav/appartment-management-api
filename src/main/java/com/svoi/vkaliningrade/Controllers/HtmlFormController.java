...
public class HtmlFormController {
    ...
    /*Контроллер только для отправки html кода,
    чтоб не писать весь html в одном файле,
    а делать запросы к этому контроллеру
    и подставлять его в нужные элементы на странице*/
